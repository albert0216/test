...
set(MSG_I_FLAGS "-Iexample:/home/aa/test/src/example/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/aa/test/src/example/msg/answer.msg" NAME_WE)
add_custom_target(_example_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "example" "/home/aa/test/src/example/msg/answer.msg" ""
)
...
_generate_msg_cpp(example
  "/home/aa/test/src/example/msg/answer.msg"
  "${MSG_I_FLAGS}"
  ""
